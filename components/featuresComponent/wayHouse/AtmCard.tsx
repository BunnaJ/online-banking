...
const ATMCard = () => {
  ...
  return (
    <div
      className="w-[450px] h-[270px] mt-10 pr-7"
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between pt-8">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="60" height="45" viewBox="0 0 48 36" fill="none">
                <rect width="48" height="36" rx="4" fill="#D4AF37" />
                <path d="M8 0v36M16 0v36M24 0v36M32 0v36M40 0v36" stroke="#fff" strokeWidth="1" />
                <path d="M0 12h48M0 24h48" stroke="#fff" strokeWidth="1" />
              </svg>
            </div>
            <div className="w-10 h-10">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-full h-full" fill="none">
                <path d="M7 10C8 11 8 13 7 14" stroke="white" strokeWidth="2" strokeLinecap="round" />
                <path d="M10 8C12 10 12 14 10 16" stroke="white" strokeWidth="2" strokeLinecap="round" />
                <path d="M13 6C16 9 16 15 13 18" stroke="white" strokeWidth="2" strokeLinecap="round" />
                <path d="M16 4C20 8 20 16 16 20" stroke="white" strokeWidth="2" strokeLinecap="round" />
              </svg>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="50" height="30" viewBox="0 0 48 28">
                <circle cx="18" cy="14" r="10" fill="#EB001B" />
                <circle cx="30" cy="14" r="10" fill="#F79E1B" />
                <path d="M24 14a10 10 0 0 1-6-9.165 10 10 0 0 1 0 18.33A10 10 0 0 1 24 14z" fill="#FF5F00" />
              </svg>
            </div>
          </div>
        </div>
