      ...
      <div className="flex items-center justify-center gap-4">
        ...
        <div className="flex items-center gap-4 p-4 bg-white rounded-xl shadow transition hover:shadow-md w-[200px]">
          ...
          <div>
            ...
            <p className="font-bold text-l text-gray-800">$250.31</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 p-4 bg-white rounded-xl shadow transition hover:shadow-md w-[200px]">
          ...
          <div>
            ...
            <p className="font-bold text-l text-gray-800">$1,200,000</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 p-4 bg-white rounded-xl shadow transition hover:shadow-md w-[200px]">
          ...
          <div>
            ...
            <p className="font-bold text-l text-gray-800">$800,000</p>
          </div>
        </div>
      </div>
    </div>
